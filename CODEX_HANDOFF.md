...
- 2026-06-28 時点の `main` 最新は PR #19 merge commit `37081a5`。`PHASE2-HOOK-PRODUCTION` では off-settings XHR の body 非読取と、`SyncCapture` 未注入時の retry 可能性をローカルテストで固定済み。明示 teardown は watch-item だが launch blocker ではない。
