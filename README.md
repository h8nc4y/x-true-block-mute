...
- 残作業: 公開後運用（不具合報告対応・X 側変更の追従。手順は `docs/review-response-playbook.md` §3〜§4）と、オーナー未回答の要件確認（`docs/requirements-v2-2026-07.md` §7 Q3〜Q7）。公開版は v1.1.1 で現行 `manifest.json` と一致しています。docs の分類索引は `docs/README.md` を参照してください。
