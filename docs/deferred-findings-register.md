...
With the extension published and `REVIEW-2026-07-15-SYNC-STAGING` resolved, the next agent-safe work is the synthetic reproducibility check for `REVIEW-2026-07-15-STORAGE-LANE`, followed by the low-confidence reserved-path check, post-publication operations, documentation consistency, and local check maintenance. Do not change permissions or product data sources.
