...
3. 公開版と現行 repo のバージョン一致を確認（2026-07-06 実施済み: 公開版 = v1.1.1 で一致）。
4. repo 側: `TASKS_BACKLOG.md` P2-021 を done 化、README の状態記述を「公開済み」へ更新、公開日を記録（エージェント。2026-07-06 実施済み）。
